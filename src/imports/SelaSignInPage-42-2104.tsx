import svgPaths from "./svg-703ub5k12o";
...
function Frame82() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-start not-italic relative shrink-0 text-center text-white">
      <p className="font-['IBM_Plex_Mono:SemiBold',_sans-serif] leading-[120px] relative shrink-0 text-[64px] w-[538px]">Sign In</p>
      <div className="flex flex-col font-['Aileron:Regular',_sans-serif] justify-center leading-[0] relative shrink-0 text-[18px] w-[562px]">
        <p className="leading-[24px]">Welcome back to Sela world!</p>
      </div>
    </div>
  );
}
...
function Frame84() {
  return (
    <div className="content-stretch flex flex-col gap-[15px] items-start relative shrink-0">
      <div className="flex flex-col font-['Aileron:Regular',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-nowrap text-white">
        <p className="leading-[24px] whitespace-pre">Category</p>
      </div>
      <div className="h-[46px] relative shrink-0 w-[563px]">
        <div aria-hidden="true" className="absolute border-[0.4px] border-solid border-white inset-0 pointer-events-none" />
      </div>
...
function Frame93() {
  return (
    <div className="bg-[#a1bcf2] box-border content-stretch flex h-[62px] items-center justify-center px-[24px] py-[12px] relative rounded-[4px] shrink-0 w-[153px]">
      <p className="font-['IBM_Plex_Mono:Regular',_sans-serif] leading-[32px] not-italic relative shrink-0 text-[24px] text-[rgba(255,255,255,0.8)] text-center text-nowrap whitespace-pre">SIGN UP</p>
    </div>
  );
}
...
export default function SelaSignInPage() {
  return (
    <div className="bg-[#f6edda] relative size-full" data-name="Sela - Sign In Page">
