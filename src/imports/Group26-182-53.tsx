...
function TextContent() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="textContent">
      <p className="font-['FONTSPRING_DEMO_-_Deca_Serif_New:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[32px] text-white uppercase w-[443px]">TALK TO SELA ANYTIME</p>
...
function TextContent1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="textContent">
      <p className="font-['FONTSPRING_DEMO_-_Deca_Serif_New:Regular',_sans-serif] h-[37px] leading-[24px] not-italic relative shrink-0 text-[32px] text-white uppercase w-[636px]">Get Your Personalized Action Plan</p>
      <div className="h-0 relative shrink-0 w-[227px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-2px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 227 2">
            <line id="Line 1" stroke="var(--stroke-0, white)" strokeWidth="2" x2="227" y1="1" y2="1" />
...
function TextContent2() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="textContent">
      <p className="font-['FONTSPRING_DEMO_-_Deca_Serif_New:Regular',_sans-serif] leading-[24px] not-italic relative shrink-0 text-[32px] text-white uppercase w-[648px]">Meet Your Perfect Match</p>
      <div className="h-0 relative shrink-0 w-[227px]">
        <div className="absolute bottom-0 left-0 right-0 top-[-2px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 227 2">
            <line id="Line 1" stroke="var(--stroke-0, white)" strokeWidth="2" x2="227" y1="1" y2="1" />
